Feature: Search Component - Huur Tab Tests
  ...
  Scenario: Check defaults for huur tab
  ...
  Scenario: Make a search on Huur tab - use all criterias
    And I write "Diemen" on address textbox
  ...
  Scenario: Make a search on Huur tab - use min and max price criterias
    And I select a random min price
    And I select a random max price higher than selected min price
    And I click to Zoek button
    Then I should be at "huur" listing page
  ...
  Scenario: Make a search on Huur tab - just use random distance criteria
    And I select a random distance
    And I click to Zoek button
    Then I should be at "huur" listing page
    And I should see correct values on filters

  Scenario: Make a search on Huur tab - just use min price criteria
    And I select a random min price
    And I click to Zoek button
    Then I should be at "huur" listing page
    And I should see correct values on filters

  Scenario: Make a search on Huur tab - just use max price criteria
  ...
  Scenario: Save and show last searched criterias on the search component - use all criterias
    ...
    And I select a random max price higher than selected min price
    And I click to Zoek button
    And I should be at "huur" listing page
